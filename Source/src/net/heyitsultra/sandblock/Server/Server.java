package net.heyitsultra.sandblock.Server;
...
public class Server {
	...
	private void process(DatagramPacket packet) {
		...
		if (new String(data, 0, 4).equals("UNDB")) {
			UNDatabase db = UNDatabase.deserialize(data);
			dump(db);
		}
	}
	...
	private void dump(UNDatabase db) {
